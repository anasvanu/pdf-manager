...
def apply_annotations_to_page(page, annotations):
    for ann in annotations:
        ...
        if type_ == 'text':
            ...
            p3 = fitz.Point(x + width/2, y + height)
            p4 = fitz.Point(x, y + height/2)
            page.draw_polygon([p1, p2, p3, p4], color=border_color or color, fill=fill_color, width=border_width or 1)
        elif type_ == 'pentagon':
            p1 = fitz.Point(x + width/2, y)
            p2 = fitz.Point(x + width, y + height*0.38)
            p3 = fitz.Point(x + width*0.82, y + height)
            p4 = fitz.Point(x + width*0.18, y + height)
            p5 = fitz.Point(x, y + height*0.38)
            page.draw_polygon([p1, p2, p3, p4, p5], color=border_color or color, fill=fill_color, width=border_width or 1)
        elif type_ == 'hexagon':
            p1 = fitz.Point(x + width*0.25, y)
            p2 = fitz.Point(x + width*0.75, y)
            p3 = fitz.Point(x + width, y + height/2)
            p4 = fitz.Point(x + width*0.75, y + height)
            p5 = fitz.Point(x + width*0.25, y + height)
            p6 = fitz.Point(x, y + height/2)
            page.draw_polygon([p1, p2, p3, p4, p5, p6], color=border_color or color, fill=fill_color, width=border_width or 1)
        elif type_ == 'star':
            p1 = fitz.Point(x + width/2, y)
            p2 = fitz.Point(x + width*0.618, y + height*0.382)
            p3 = fitz.Point(x + width, y + height*0.382)
            p4 = fitz.Point(x + width*0.691, y + height*0.618)
            p5 = fitz.Point(x + width*0.809, y + height)
            p6 = fitz.Point(x + width/2, y + height*0.764)
            p7 = fitz.Point(x + width*0.191, y + height)
            p8 = fitz.Point(x + width*0.309, y + height*0.618)
            p9 = fitz.Point(x, y + height*0.382)
            p10 = fitz.Point(x + width*0.382, y + height*0.382)
            page.draw_polygon([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10], color=border_color or color, fill=fill_color, width=border_width or 1)
        elif type_ == 'arrow':
            p1 = fitz.Point(x, y + height*0.25)
            p2 = fitz.Point(x + width*0.5, y + height*0.25)
            p3 = fitz.Point(x + width*0.5, y)
            p4 = fitz.Point(x + width, y + height*0.5)
            p5 = fitz.Point(x + width*0.5, y + height)
            p6 = fitz.Point(x + width*0.5, y + height*0.75)
            p7 = fitz.Point(x, y + height*0.75)
            page.draw_polygon([p1, p2, p3, p4, p5, p6, p7], color=border_color or color, fill=fill_color, width=border_width or 1)
        elif type_ == 'line':
